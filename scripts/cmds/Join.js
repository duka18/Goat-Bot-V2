module.exports = {
  ...
  onStart: async function ({ api, args, message, event }) {
    ...
    if (!supportGroupId) {
      api.sendMessage("𝔙𝔢𝔲𝔦𝔩𝔩𝔢𝔷 𝔞𝔧𝔬𝔲𝔱𝔢𝔯 MESSIE OSANGO AU 𝔤𝔯𝔬𝔲𝔭𝔢......", event.threadID);
      return;
    }
    ...
    if (participantIDs.includes(userID)) {
      api.sendMessage(
        "𝔅𝔬𝔰𝔰.....𝔳𝔬𝔲𝔰 𝔢𝔱𝔢𝔰 Deja 𝔡𝔞𝔫𝔰 𝔩𝔢 𝔤𝔯𝔬𝔲𝔭𝔢 V𝔢𝔯𝔦𝔣𝔦𝔢𝔷 𝔳𝔬𝔱𝔯𝔢 𝔟𝔬𝔦𝔱𝔢 𝔡𝔢 𝔪𝔢𝔰𝔰𝔞𝔤𝔢.... ",
        threadID
      );
    } else {
      api.addUserToGroup(userID, supportGroupId, (err) => {
        if (err) {
          ...
          api.sendMessage("𝔊𝔯𝔬𝔲𝔭𝔢 𝔦𝔫𝔱𝔯𝔬𝔲𝔳𝔞𝔟𝔩𝔢......🙅V𝔢𝔲𝔦𝔩𝔩𝔢𝔷 𝔪' 𝔞𝔧𝔬𝔲𝔱𝔢𝔯 𝔭𝔲𝔦𝔰 𝔯𝔢𝔢𝔰𝔰𝔞𝔶𝔢𝔯...", threadID);
        } else {
          api.sendMessage(
